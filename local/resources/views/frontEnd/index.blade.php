...
<section data-bs-version="5.1" class="slider1 cid-tk1A7inTUj" id="slider1-27">
    ...
    <div class="carousel slide carousel-fade" id="tk232l0MU6" data-ride="carousel" data-bs-ride="carousel" data-interval="3000" data-bs-interval="3000">
        <ol class="carousel-indicators">
            <li data-slide-to="0" data-bs-slide-to="0" class="active" data-target="#tk232l0MU6" data-bs-target="#tk232l0MU6"></li>
            <li data-slide-to="1" data-bs-slide-to="1" data-target="#tk232l0MU6" data-bs-target="#tk232l0MU6"></li>
            <li data-slide-to="2" data-bs-slide-to="2" data-target="#tk232l0MU6" data-bs-target="#tk232l0MU6"></li>
        </ol>
        <div class="carousel-inner">
            <div class="carousel-item slider-image item active">
                <div class="item-wrapper">
                    <img class="d-block w-100" src="local/public/assets/images/screenshot-2022-10-05-154230-1063x595.png" alt="">
            ...
            <div class="carousel-item slider-image item">
                <div class="item-wrapper">
                    <img class="d-block w-100" src="local/public/assets/images/240041926-896817154239144-5194890289308605773-n-508x381.jpg" alt="">
        ...
        <a class="carousel-control carousel-control-prev" role="button" data-slide="prev" data-bs-slide="prev" href="#tk232l0MU6">
            <span class="mobi-mbri mobi-mbri-arrow-prev" aria-hidden="true"></span>
            <span class="sr-only visually-hidden">Previous</span>
        </a>
        <a class="carousel-control carousel-control-next" role="button" data-slide="next" data-bs-slide="next" href="#tk232l0MU6">
...
<section data-bs-version="5.1" class="gallery3 cid-tk1VgHWbQY" id="gallery3-2m">
    
    
    <div class="container-fluid">
        <div class="mbr-section-head">
            <h4 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2">
                <strong>Catering Services</strong></h4>
...
{{-- <section data-bs-version="5.1" class="gallery3 cid-tk1WfbmPNt" id="gallery3-2n">
    ...
    <div class="container-fluid">
        <div class="mbr-section-head">
            <h4 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2">
                <strong>Wedding Attire for Men</strong></h4>
        ...
        <div class="row mt-4">
            <div class="item features-image сol-12 col-md-6 col-lg-3">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="local/public/assets/images/dinner-suit-black-tie-634x444.png" alt="">
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-7">
            ...
            <div class="item features-image сol-12 col-md-6 col-lg-3">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="local/public/assets/images/bold-check-double-breasted-waitcoats-558x368.png" alt="">
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-7">
                            <strong>Card Title</strong>
            ...
            <div class="item features-image сol-12 col-md-6 col-lg-3">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="local/public/assets/images/double-breasted-682x450.png" alt="">
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-7">
                            <strong>Card Title</strong>
            ...
            <div class="item features-image сol-12 col-md-6 col-lg-3">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="local/public/assets/images/bold-check-suits-650x437.png" alt="" title="">
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-7">
                            <strong>Card Title</strong>
                        ...
                        <div class="carousel slide carousel-fade" id="lb-tmZ8WbC2bH" data-ride="carousel" data-bs-ride="carousel" data-interval="5000" data-bs-interval="5000">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img class="d-block w-100" src="local/public/assets/images/239931006-896817200905806-2335309167806016982-n-894x671.jpg" alt="Mobirise Website Builder">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="local/public/assets/images/22814197-1141277422674783-2697895112028114431-n-894x671.jpg" alt="Mobirise Website Builder">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="local/public/assets/images/5e3e25c307a8c057399283-720x432.jpg" alt="Mobirise Website Builder">
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="local/public/assets/images/240041926-896817154239144-5194890289308605773-n-894x671.jpg" alt="Mobirise Website Builder">
                                </div>
                            </div>
                            <ol class="carousel-indicators">
                                <li data-slide-to="0" data-bs-slide-to="0" class="active" data-target="#lb-tmZ8WbC2bH" data-bs-target="#lb-tmZ8WbC2bH"></li>
                                <li data-slide-to="1" data-bs-slide-to="1" data-target="#lb-tmZ8WbC2bH" data-bs-target="#lb-tmZ8WbC2bH"></li>
                                <li data-slide-to="2" data-bs-slide-to="2" data-target="#lb-tmZ8WbC2bH" data-bs-target="#lb-tmZ8WbC2bH"></li>
                                <li data-slide-to="3" data-bs-slide-to="3" data-target="#lb-tmZ8WbC2bH" data-bs-target="#lb-tmZ8WbC2bH"></li>
                            </ol>
                            <a role="button" href="" class="close" data-dismiss="modal" data-bs-dismiss="modal" aria-label="Close">
                            </a>
                            <a class="carousel-control-prev carousel-control" role="button" data-slide="prev" data-bs-slide="prev" href="#lb-tmZ8WbC2bH">
                                <span class="mobi-mbri mobi-mbri-arrow-prev" aria-hidden="true"></span>
                                <span class="sr-only visually-hidden">Previous</span>
                            </a>
                            <a class="carousel-control-next carousel-control" role="button" data-slide="next" data-bs-slide="next" href="#lb-tmZ8WbC2bH">
                                <span class="mobi-mbri mobi-mbri-arrow-next" aria-hidden="true"></span>
                                <span class="sr-only visually-hidden">Next</span>
                            </a>
                        </div>
